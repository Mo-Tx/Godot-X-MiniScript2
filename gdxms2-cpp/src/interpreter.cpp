...
void Interpreter::_bind_methods() {
	...
	godot::ClassDB::bind_static_method("Interpreter", D_METHOD("create", "source_code", "standard_output", "error_output"), &Interpreter::create, DEFVAL(""), DEFVAL(godot::Callable()), DEFVAL(godot::Callable()));

	godot::ClassDB::bind_method(/*"Interpreter", */D_METHOD("set_standard_output", "standard_output"), &Interpreter::set_standard_output, DEFVAL(godot::Callable()));
	godot::ClassDB::bind_method(/*"Interpreter", */D_METHOD("set_error_output", "error_output"), &Interpreter::set_error_output, DEFVAL(godot::Callable()));

	//  MEMBER //
	godot::ClassDB::bind_method(D_METHOD("init", "source_code", "standard_output", "error_output"), &Interpreter::init, DEFVAL(""), DEFVAL(godot::Callable()), DEFVAL(godot::Callable()));
...
Interpreter::Interpreter(godot::String source_code, godot::Callable standard_output, godot::Callable error_output) {
...
Interpreter *Interpreter::create(godot::String source_code, godot::Callable standard_output, godot::Callable error_output) {
	return memnew(Interpreter(source_code, standard_output, error_output));
}
...
/*  MEMBER */
void Interpreter::init(godot::String source_code, godot::Callable standard_output, godot::Callable error_output) {
